...
# installed.
TCL_PREFIX='B:/Estudos/Projetos/Python/Max\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='B:/Estudos/Projetos/Python/Max\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='B:/Estudos/Projetos/Python/Max\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IB:/Estudos/Projetos/Python/Max\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LB:/Estudos/Projetos/Python/Max\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='B:/Estudos/Projetos/Python/Max\Library\lib\tclstub86.lib'
